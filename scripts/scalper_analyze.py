"""
scalper_analyze.py — Institutional Edition (prompt.txt v3)
Usage: python scalper_analyze.py SYMBOL [open1,open2,...]
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scalper_analyze.py SYMBOL [open1,open2,...]")
        sys.exit(1)
