"""
skill_manage.py — Institutional Edition
Open position monitor + management advisor.

Usage:
  python skill_manage.py SYMBOL DIRECTION ENTRY SL TP1 TP2
...
def parse_args():
    args = sys.argv[1:]
    if len(args) < 6:
        print("Usage: python skill_manage.py SYMBOL DIRECTION ENTRY SL TP1 TP2")
        print("Example: python skill_manage.py SOLUSDT LONG 145.50 140.00 156.00 165.00")
        sys.exit(1)
    symbol    = args[0].upper()
