...
### Meme Rush â€” Launchpad token lifecycle tracking
...
### Topic Rush â€” AI-powered market hot topic discovery

| rankType | Stage | Description |
|----------|-------|-------------|
| 10 | Latest | Newest hot topics |
| 20 | Rising | Rising topics with all-time high inflow between $1kâ€“$20k |

## Use Cases

1. **Snipe New Launches**: Find freshly created meme tokens on Pump.fun, Four.meme, etc.
2. **Migration Watch**: Monitor tokens about to migrate â€” catch early DEX liquidity
...
2. Percentage fields (progress, holder %, dev sell %, tax rate) are pre-formatted â€” append `%` directly
