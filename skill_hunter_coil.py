"""
skill_hunter_coil.py — Institutional Edition
Coil Scorer + Trade Plan Generator for individual symbols.

Usage:
  python skill_hunter_coil.py SYMBOL [SYMBOL2 SYMBOL3 ...]
  python skill_hunter_coil.py SOLUSDT ETHUSDT PEPEUSDT
...
Purpose:
  ...
  For a full market-wide scan, use skill_hunter_scan.py instead.
...
def main():
    ...
    if not symbols:
        print("Usage: python skill_hunter_coil.py SYMBOL [SYMBOL2 ...]")
        print("Example: python skill_hunter_coil.py SOLUSDT ETHUSDT PEPEUSDT")
        sys.exit(1)
