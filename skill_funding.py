"""
skill_funding.py — Institutional Edition
Funding rate scanner for Binance Futures perpetuals.

Usage:
  python skill_funding.py                     → scan all futures for extreme funding
  python skill_funding.py SOLUSDT ETHUSDT     → check specific symbols only
  python skill_funding.py --watchlist         → check symbols from watchlist.txt
